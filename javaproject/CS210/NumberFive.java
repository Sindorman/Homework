...
public class NumberFive{
	public static void main(String[] args){
		...
		double Longone = Math.toRadians(Negative(console.nextDouble()));
		...
		double Longtwo = Math.toRadians(Negative(console.nextDouble()));
	...
	public static double Negative( double b){
		return b-b*2;
	}
}