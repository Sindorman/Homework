...
class PokerCardFactory {
	  ...
	  static PokerCard create(String rankAndSuit) {		  
		  String rank = "" + rankAndSuit.charAt(0);
		  String suit = "" + rankAndSuit.charAt(1);
		  if (PokerCard.isRank(rank) && PokerCard.isSuit(suit)){
