...
p1a_test2 = TestCase (assertEqual "merge2 [] [1,3,4,5,7,8,10]" [1,3,4,5,7,8,10]  (merge2 [] [1,3,4,5,7,8,10]) ) 
...
p2a_test3 = TestCase (assertEqual "getInRange (-1) 1 []" [] (getInRange (-1) 1 []) )
p2a_test4 = TestCase (assertEqual "getInRange (-1) 1 [1, 2, 0]" [0] (getInRange (-1) 1 [1, 2, 0]) )
